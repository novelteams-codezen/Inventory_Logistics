...
using Inventory_Logistics.Services;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Inventory_Logistics", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<Inventory_LogisticsContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Inventory_Logistics API v1");

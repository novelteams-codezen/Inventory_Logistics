namespace Inventory_Logistics.Services
{
    using System;
    ...
    {
        private Inventory_LogisticsContext _dbContext;
        public UserAuthenticationService(Inventory_LogisticsContext dbContext)
        {

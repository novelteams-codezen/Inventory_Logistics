...
namespace Inventory_Logistics.Entities
{
    ...
    public class GoodsReceiptActivityHistory
    {
        ...
        /// <summary>
        /// Required field FromStep of the GoodsReceiptActivityHistory 
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// Required field TransactionDate of the GoodsReceiptActivityHistory 
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// Required field Description of the GoodsReceiptActivityHistory 
        /// </summary>
        [Required]
        public string Description { get; set; }

        /// <summary>
        /// Required field Active of the GoodsReceiptActivityHistory 
        /// </summary>
        [Required]
